            ...
            <div className="flex flex-wrap justify-between mt-10 gap-0">
                {links.map(i => 
                    <Link href={i.link} target="_blank" key={i.link} className="link-card w-full lg:w-72 h-32 cursor-pointer">
                        <span className="border border-[#303030]/25 dark:border-white/25 hover:border-opacity-60 dark:hover:border-opacity-25 rounded-lg p-4 dark:hover:bg-[#202020] text-left flex flex-col items-start justify-between">
